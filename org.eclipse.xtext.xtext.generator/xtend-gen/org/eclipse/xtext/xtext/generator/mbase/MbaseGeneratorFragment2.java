...
public class MbaseGeneratorFragment2 extends AbstractXtextGeneratorFragment {
  ...
  public void generate() {
    boolean _inheritsMbase = this._mbaseUsageDetector.inheritsMbase(this.getGrammar());
    boolean _not = (!_inheritsMbase);
    if (_not) {
      return;
    }
    ...
    if (_tripleNotEquals_1) {
      ...
      String _plus = ("org.eclipse.xtext.mbase.lib;bundle-version=\"" + _xbaseLibVersionLowerBound);
      String _plus_1 = (_plus + "\"");
      this.getProjectConfig().getRuntime().getManifest().getRequiredBundles().addAll(
        Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("org.eclipse.xtext.mbase", _plus_1)));
    ...
    if (_tripleNotEquals_2) {
      this.getProjectConfig().getEclipsePlugin().getManifest().getRequiredBundles().addAll(
        Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("org.eclipse.xtext.mbase.ui", "org.eclipse.jdt.debug.ui")));
    }
    GuiceModuleAccess _ideGenModule = this.getLanguage().getIdeGenModule();
    _ideGenModule.setSuperClass(TypeReference.typeRef("org.eclipse.xtext.mbase.ide.DefaultMbaseIdeModule"));
    GuiceModuleAccess _webGenModule = this.getLanguage().getWebGenModule();
    _webGenModule.setSuperClass(TypeReference.typeRef("org.eclipse.xtext.mbase.web.DefaultMbaseWebModule"));
  }
      ...
      if (_tripleNotEquals) {
        ...
        StringConcatenationClient _client = new StringConcatenationClient() {
          ...
          protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
            ...
            String _simpleName = MbaseGeneratorFragment2.this._xtextGeneratorNaming.getEclipsePluginEditor(MbaseGeneratorFragment2.this.getGrammar()).getSimpleName();
            _builder.append(_simpleName);
            _builder.append(" extends ");
            TypeReference _eclipsePluginXbaseEditor = MbaseGeneratorFragment2.this._xtextGeneratorNaming.getEclipsePluginXbaseEditor(MbaseGeneratorFragment2.this.getGrammar());
  ...
  protected void contributeRuntimeGuiceBindings() {
    final GuiceModuleAccess.BindingFactory bindingFactory = new GuiceModuleAccess.BindingFactory().addTypeToType(TypeReference.typeRef(IQualifiedNameProvider.class), 
      TypeReference.typeRef("org.eclipse.xtext.mbase.scoping.MbaseQualifiedNameProvider"));
    boolean _usesXImportSection = this._mbaseUsageDetector.usesXImportSection(this.getGrammar());
    ...
    if (_not) {
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          TypeReference _typeReference = new TypeReference("org.eclipse.xtext.mbase.imports", "RewritableImportSection.Factory");
    ...
    if (this.useInferredJvmModel) {
      bindingFactory.addTypeToType(TypeReference.typeRef(ILocationInFileProvider.class), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.jvmmodel.JvmLocationInFileProvider")).addTypeToType(TypeReference.typeRef(IGlobalScopeProvider.class), 
        TypeReference.typeRef("org.eclipse.xtext.common.types.xtext.TypesAwareDefaultGlobalScopeProvider")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.mbase.validation.FeatureNameValidator"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.validation.LogicalContainerAwareFeatureNameValidator")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.mbase.typesystem.internal.DefaultBatchTypeResolver"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.typesystem.internal.LogicalContainerAwareBatchTypeResolver")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.mbase.typesystem.internal.DefaultReentrantTypeResolver"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.typesystem.internal.LogicalContainerAwareReentrantTypeResolver")).addTypeToType(TypeReference.typeRef(IResourceValidator.class), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.annotations.validation.DerivedStateAwareResourceValidator"));
      if (this.generateXtendInferrer) {
        bindingFactory.addTypeToType(TypeReference.typeRef("org.eclipse.xtext.mbase.jvmmodel.IJvmModelInferrer"), this.getJvmModelInferrer());
      }
    } else {
      bindingFactory.addTypeToType(TypeReference.typeRef(ILocationInFileProvider.class), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.resource.MbaseLocationInFileProvider"));
    }
    bindingFactory.contributeTo(this.getLanguage().getRuntimeGenModule());
    boolean _inheritsMbaseWithAnnotations = this._mbaseUsageDetector.inheritsMbaseWithAnnotations(this.getLanguage().getGrammar());
    if (_inheritsMbaseWithAnnotations) {
      GuiceModuleAccess _runtimeGenModule = this.getLanguage().getRuntimeGenModule();
      _runtimeGenModule.setSuperClass(TypeReference.typeRef("org.eclipse.xtext.mbase.annotations.DefaultMbaseWithAnnotationsRuntimeModule"));
    } else {
      GuiceModuleAccess _runtimeGenModule_1 = this.getLanguage().getRuntimeGenModule();
      _runtimeGenModule_1.setSuperClass(TypeReference.typeRef("org.eclipse.xtext.mbase.DefaultMbaseRuntimeModule"));
    }
  }
  ...
  protected void contributeEclipsePluginGuiceBindings() {
    ...
    if (this.useInferredJvmModel) {
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          TypeReference _typeRef_3 = TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.navigation.DerivedMemberAwareEditorOpener");
          ...
          _builder.append(".class).to(");
          TypeReference _typeRef_5 = TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.navigation.DerivedMemberAwareEditorOpener");
      ...
      GuiceModuleAccess.BindingFactory _addTypeToType = bindingFactory.addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.editor.findrefs.FindReferencesHandler"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.findrefs.JvmModelFindReferenceHandler")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.editor.findrefs.ReferenceQueryExecutor"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.findrefs.JvmModelReferenceQueryExecutor")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.refactoring.IDependentElementsCalculator"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.refactoring.JvmModelDependentElementsCalculator")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.refactoring.IRenameRefactoringProvider"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.refactoring.jdt.CombinedJvmJdtRenameRefactoringProvider")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.refactoring.IReferenceUpdater"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.refactoring.MbaseReferenceUpdater")).addfinalTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.refactoring.ui.IRenameContextFactory"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.refactoring.jdt.CombinedJvmJdtRenameContextFactory")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.refactoring.IRenameStrategy"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.refactoring.DefaultJvmModelRenameStrategy"));
      ...
      TypeReference _typeReference_1 = new TypeReference("org.eclipse.xtext.mbase.ui.jvmmodel.refactoring", "JvmModelJdtRenameParticipantContext.ContextFactory");
      GuiceModuleAccess.BindingFactory _addTypeToType_1 = _addTypeToType.addTypeToType(_typeReference, _typeReference_1).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.editor.outline.impl.OutlineNodeElementOpener"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.jvmmodel.outline.JvmOutlineNodeElementOpener")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.editor.GlobalURIEditorOpener"), 
      ...
      bindingFactory.addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.refactoring.IRenameStrategy"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.refactoring.MbaseRenameStrategy"));
    }
    boolean _usesXImportSection = this._mbaseUsageDetector.usesXImportSection(this.getLanguage().getGrammar());
    if (_usesXImportSection) {
      bindingFactory.addTypeToType(TypeReference.typeRef("org.eclipse.xtext.mbase.imports.IUnresolvedTypeResolver"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.imports.InteractiveUnresolvedTypeResolver")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.common.types.xtext.ui.ITypesProposalProvider"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.contentassist.ImportingTypesProposalProvider")).addTypeToType(TypeReference.typeRef("org.eclipse.xtext.ui.editor.templates.XtextTemplateContextType"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.templates.MbaseTemplateContextType"));
    } else {
      bindingFactory.addTypeToType(TypeReference.typeRef("org.eclipse.xtext.mbase.ui.quickfix.JavaTypeQuickfixes"), 
        TypeReference.typeRef("org.eclipse.xtext.mbase.ui.quickfix.JavaTypeQuickfixesNoImportSection"));
    }
    ...
    if (_inheritsMbaseWithAnnotations) {
      ...
      _eclipsePluginGenModule.setSuperClass(TypeReference.typeRef("org.eclipse.xtext.mbase.annotations.ui.DefaultMbaseWithAnnotationsUiModule"));
    } else {
      GuiceModuleAccess _eclipsePluginGenModule_1 = this.getLanguage().getEclipsePluginGenModule();
      _eclipsePluginGenModule_1.setSuperClass(TypeReference.typeRef("org.eclipse.xtext.mbase.ui.DefaultMbaseUiModule"));
    }
  }
  ...
  protected void doGenerateXtendInferrer() {
    ...
    StringConcatenationClient _client = new StringConcatenationClient() {
      ...
      protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
        ...
        _builder.newLine();
        _builder.append("class ");
        String _simpleName = MbaseGeneratorFragment2.this.getJvmModelInferrer().getSimpleName();
        _builder.append(_simpleName);
        _builder.append(" extends ");
        TypeReference _typeRef = TypeReference.typeRef("org.eclipse.xtext.mbase.jvmmodel.AbstractModelInferrer");
        _builder.append(_typeRef);
        _builder.append(" {");
        _builder.newLineIfNotEmpty();
        _builder.newLine();
        ...
        TypeReference _typeRef_1 = TypeReference.typeRef("org.eclipse.xtext.mbase.jvmmodel.JvmTypesBuilder");
        _builder.append(_typeRef_1, "\t");
        _builder.newLineIfNotEmpty();
        _builder.newLine();
        _builder.append("\t");
        ...
        TypeReference _typeRef_2 = TypeReference.typeRef("org.eclipse.xtext.mbase.jvmmodel.IJvmDeclaredTypeAcceptor");
        _builder.append(_typeRef_2, "\t");
  ...
  protected boolean contributeEclipsePluginExtensions() {
    boolean _xblockexpression = false;
    {
      ...
      if (this.jdtTypeHierarchy) {
        ...
        _builder.append(":org.eclipse.xtext.mbase.ui.hierarchy.OpenTypeHierarchyHandler\"");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("commandId=\"org.eclipse.xtext.mbase.ui.hierarchy.OpenTypeHierarchy\">");
        _builder.newLine();
        _builder.append("\t\t");
        ...
        _builder.append(":org.eclipse.xtext.mbase.ui.hierarchy.QuickTypeHierarchyHandler\"");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        ...
        _builder.newLine();
        {
          ...
          if (_usesXImportSection) {
            ...
            _builder.append(":org.eclipse.xtext.mbase.ui.imports.OrganizeImportsHandler\"");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("commandId=\"org.eclipse.xtext.mbase.ui.organizeImports\">");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("<activeWhen>");
        ...
        _builder.newLine();
        {
          boolean _usesXImportSection_1 = this._mbaseUsageDetector.usesXImportSection(this.getLanguage().getGrammar());
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("<command commandId=\"org.eclipse.xtext.mbase.ui.hierarchy.OpenTypeHierarchy\"");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("style=\"push\"");
        _builder.newLine();
      ...
      if (this.jdtCallHierarchy) {
        ...
        _builder_1.append(":org.eclipse.xtext.mbase.ui.hierarchy.OpenCallHierachyHandler\"");
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t\t");
        _builder_1.append("commandId=\"org.eclipse.xtext.mbase.ui.hierarchy.OpenCallHierarchy\">");
        _builder_1.newLine();
        _builder_1.append("\t\t");
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t");
        _builder_1.append("<command commandId=\"org.eclipse.xtext.mbase.ui.hierarchy.OpenCallHierarchy\"");
        _builder_1.newLine();
        _builder_1.append("\t\t\t");
      ...
      _builder_2.append(":org.eclipse.xtext.mbase.ui.refactoring.ExtractVariableHandler\"");
      _builder_2.newLineIfNotEmpty();
      _builder_2.append("\t\t");
      _builder_2.append("commandId=\"org.eclipse.xtext.mbase.ui.refactoring.ExtractLocalVariable\">");
      _builder_2.newLine();
      _builder_2.append("\t\t");
      ...
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("<command commandId=\"org.eclipse.xtext.mbase.ui.refactoring.ExtractLocalVariable\"");
      _builder_2.newLine();
      _builder_2.append("\t\t\t");
      _builder_2.append("style=\"push\">");
      _builder_2.newLine();
      ...
      _builder_2.append(":org.eclipse.xtext.mbase.ui.navigation.OpenImplementationHandler\"");
      _builder_2.newLineIfNotEmpty();
      _builder_2.append("\t\t");
      _builder_2.append("commandId=\"org.eclipse.xtext.mbase.ui.OpenImplementationCommand\">");
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("<activeWhen>");
      _builder_2.newLine();
      ...
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("<command commandId=\"org.eclipse.xtext.mbase.ui.OpenImplementationCommand\">");
      _builder_2.newLine();
      _builder_2.append("\t\t\t");
      _builder_2.append("<visibleWhen checkEnabled=\"false\">");
      _builder_2.newLine();
